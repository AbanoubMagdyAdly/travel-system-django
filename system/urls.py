...
urlpatterns = [
    ...
    url(r'^country/(?P<country_id>[0-9]+)/city/(?P<city_id>[0-9]+)/blog$', blog.experience_new, name='blog'),
    url(r'^country/(?P<country_id>[0-9]+)/city/(?P<city_id>[0-9]+)/blog/(?P<experienceid>[0-9]+)/$', blog.comment_new, name='single_exprience'),
